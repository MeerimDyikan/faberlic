    ...
    <>
      ...
      <section>
        ...
        <div className="about-content" >
          <div className="about flex"> <img data-st-lazy="min-width: 0px => https://static.faberlic.com/fl_about/assets/images/02_about/03.png, https://static.faberlic.com/fl_about/assets/images/02_about/03.webp" src="https://static.faberlic.com/fl_about/assets/images/02_about/03.webp" alt="" />
      ...
      <div className=" h-history_cards flex">
        ...
        <div className="h-history__card  " data-shooter-target="2">
          ...
          <div className="h-history__card__content">
            <div className="h-text-100-70-40 h-text-w-900 h-history__card__year">2019</div>
            <div className="h-text-18-14-14 h-history__card__desc">
        ...
        <div className="h-history__card " data-shooter-target="3">
          ...
          <div className="h-history__card__content">
            <div className="h-text-100-70-40 h-text-w-900 h-history__card__year">2018</div>
            <div className="h-text-18-14-14 h-history__card__desc">
              В нашем портфолио появляется ещё две звёздные коллаборации. Вместе с актрисой и режиссёром Ренатой Литвиновой мы создаём эксклюзивный аромат и линейку декоративной косметики, а с актрисой Юлией Высоцкой – коллекцию стильных аксессуаров для кухни.<br /><br />
        ...
        <div className="h-history__card " data-shooter-target="4">
          ...
          <div className="h-history__card__content">
            <div className="h-text-100-70-40 h-text-w-900 h-history__card__year">2017</div>
            <div className="h-text-18-14-14 h-history__card__desc">
              В 2017 году Faberlic создаёт две совместные коллекции с кутюрье Валентином Юдашкиным. Мы перенесли принципы высокой моды в одежду, доступную каждой женщине. В коллекцию Faberlic by Valentin Yudashkin вошли также три аромата: два женских и один мужской, которые остаются хитами.<br />&nbsp;<br />
        ...
        <div className="h-history__card " data-shooter-target="5">
          ...
          <div className="h-history__card__content">
            <div className="h-text-100-70-40 h-text-w-900 h-history__card__year">2016</div>
            <div className="h-text-18-14-14 h-history__card__desc">
              В 2016 году – коллаборация Faberlic с русским дизайнером Алёной Ахмадуллиной. Творения модельера были представлены на крупнейшем модном событии года – Mercedes-Benz Fashion Week в Москве и произвели настоящий фурор!<br /><br />
        ...
        <div className="h-history__card " data-shooter-target="6">
          ...
          <div className="h-history__card__content">
            <div className="h-text-100-70-40 h-text-w-900 h-history__card__year">2015</div>
            <div className="h-text-18-14-14 h-history__card__desc">
        ...
        <div className="h-history__card " data-shooter-target="7">
          ...
          <div className="h-history__card__content">
            <div className="h-text-100-70-40 h-text-w-900 h-history__card__year">2013-2014</div>
            <div className="h-text-18-14-14 h-history__card__desc">
        ...
        <div class="h-history__card injured" data-shooter-target="8">
          ...
          <div className="h-history__card__content">
            <div className="h-text-100-70-40 h-text-w-900 h-history__card__year">2011-2012</div>
            <div className="h-text-18-14-14 h-history__card__desc">
        ...
        <div className="h-history__card " data-shooter-target="9">
          ...
          <div className="h-history__card__content">
            <div className="h-text-100-70-40 h-text-w-900 h-history__card__year">2009-2010</div>
            <div className="h-text-18-14-14 h-history__card__desc">
              При поддержке Faberlic была создана общественная организация по восстановлению лесных массивов, обучению людей экологическому сознанию и борьбе с вредным воздействием на окружающую среду.<br /><br />
